...
class RekapanController extends Controller
{
    public function index()
    {
        $menu = Menu::all();
        $user = User::all();
        $rekapan = pembayaran::orderBy('id', 'asc')->get();
        return view('layouts.rekapan', compact('rekapan', 'user', 'menu'));
    }
    ...
    public function filter(Request $request)
    {
        ...
        return view('layouts.rekapan', compact('rekapan'));
    }
    ...
    public function cetakStruk()
    {
        ...
        return view('layouts.cetak-struk', compact('cetakStruk', 'usercetak', 'menus'));
    }

    public function show(User $user)
    {
        $menulihat = Menu::findOrFail($user);
        return view('layouts.cetak-struk', compact('menulihat'));
    }
